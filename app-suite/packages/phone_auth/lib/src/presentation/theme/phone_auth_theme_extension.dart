...
class PhoneAuthThemeExtension extends ThemeExtension<PhoneAuthThemeExtension> {
  ...
  PhoneAuthThemeExtension copyWith({
    ...
    TextStyle? bodyEmphasisTextStyle,
    ...
    return PhoneAuthThemeExtension(
      ...
      bodyEmphasisTextStyle:
          bodyEmphasisTextStyle ?? this.bodyEmphasisTextStyle,
  ...
  PhoneAuthThemeExtension lerp(
    ...
    return PhoneAuthThemeExtension(
      ...
      bodyEmphasisTextStyle: TextStyle.lerp(
        bodyEmphasisTextStyle,
        other.bodyEmphasisTextStyle,
        t,
      ),
      actionTextStyle:
