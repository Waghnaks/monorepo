...
import 'package:auth_phone/src/presentation/utils/phone_auth_document_url_resolver.dart';
...
class _PhoneAuthDocumentViewerState extends State<PhoneAuthDocumentViewer> {
  ...
  void initState() {
    super.initState();
    _viewType = 'phone-auth-document-viewer-${_nextViewId++}';
  ...
  void _handleLoadFailure() {
    ...
    debugPrint('PhoneAuth document viewer failed to load: ${widget.url}');
    setState(() {
      _hasLoadError = true;
    });
  }
